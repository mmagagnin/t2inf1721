...
g1={'p1': 1, 'p2': 0, 'p3': 3, 'p4': 4, 'p5': 5, 'p6': 6, 'p7': 7, 'p8': 8, 'p9': 2}

g2={'p1': 1, 'p2': 2, 'p3': 3, 'p4': 4, 'p5': 5, 'p6': 0, 'p7': 7, 'p8': 8, 'p9': 6}

print("Existe uma aresta entre esses dois nos:")
print(list(dicConfigs.keys())[list(dicConfigs.values()).index(g1)])
